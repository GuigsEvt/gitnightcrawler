...
> Generated by gitnightcrawler at Wed Apr  1 10:16:04 CEST 2026
> Powered by Trail of Bits security skills
> Single repo test run.

---

## Discovery Summary
- Main candidates scored: 183
- Marketing candidates scored: 40

## Top Repos

### 1. [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis)
> LLM驱动的 A/H/美股智能分析器：多数据源行情 + 实时新闻 + LLM决策仪表盘 + 多渠道推送，零成本定时运行，纯白嫖. LLM-powered stock analysis system for A/H/US markets.
> Stars: 27,391 | Issues: 71 | Lang: Python | Score: 184.84

### 2. [jackwener/opencli](https://github.com/jackwener/opencli)
> Make Any Website & Tool Your CLI. A universal CLI Hub and AI-native runtime. Transform any website, Electron app, or local binary into a sta
> Stars: 9,871 | Issues: 93 | Lang: TypeScript | Score: 171.15
...
> Stars: 1,432 | Issues: 137 | Lang: Go | Score: 171.1

### 4. [dataelement/Clawith](https://github.com/dataelement/Clawith)
> OpenClaw for Teams
> Stars: 2,673 | Issues: 91 | Lang: Python | Score: 169.27

### 5. [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)
> Build AI Agents, Visually
> Stars: 51,320 | Issues: 829 | Lang: TypeScript | Score: 166.28

## Security Findings Summary

| Repo | Risk | Critical | High | Medium | Low | Categories |
|------|------|----------|------|--------|-----|------------|
| bitrouter/bitrouter | UNKNOWN | 0 | 4 | 4 | 4 | ai|actions|crypto-primitives |
