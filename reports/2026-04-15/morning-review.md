...
> Generated by gitnightcrawler at Wed Apr 15 02:45:15 CEST 2026
...
> Stars: 39,520 | Issues: 925 | Lang: Python | Score: 177.43

### 2. [MemPalace/mempalace](https://github.com/MemPalace/mempalace)
> The highest-scoring AI memory system ever benchmarked. And it's free.
> Stars: 45,862 | Issues: 367 | Lang: Python | Score: 176.67
...
> Stars: 26,378 | Issues: 96 | Lang: Python | Score: 174.54

### 4. [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)
> Build AI Agents, Visually
> Stars: 51,903 | Issues: 809 | Lang: TypeScript | Score: 166.24

### 5. [debba/tabularis](https://github.com/debba/tabularis)
> A lightweight, cross-platform database client for developers. Supports MySQL, PostgreSQL and SQLite. Hackable with plugins. Built for speed,
> Stars: 1,103 | Issues: 30 | Lang: TypeScript | Score: 164.47

## Marketing Farm

### 1. [astronomer/agents](https://github.com/astronomer/agents)
> AI agent tooling for data engineering workflows.
> Stars: 316 | Issues: 12 | Lang: Python | Score: 125.27
...
> Stars: 73 | Issues: 15 | Lang: Rust | Score: 122.67
...
> Stars: 2,555 | Issues: 76 | Lang: Rust | Score: 117.0
...
| debba/tabularis | UNKNOWN | 0 | 0 | 0 | 0 | ai|actions|crypto-primitives |
...
All 5 agents complete. Audit finalized in `SECURITY_AUDIT.md`. No further action needed.
...
**Top opportunity**: 2 skills (`managing-astro-deployments`, `troubleshooting-astro-deployments`) use lowercase `skill.md` instead of `SKILL.md` -- they're invisible to users. A 5-minute `git mv` fix with near-certain merge.

**Other quick wins**:
- Add CI/PyPI badges to main README
- Fix CONTRIBUTING.md (missing `--recurse-submodules`, outdated project structure)
- GitHub issue/PR templates

The repo is well-maintained with responsive maintainers (PRs merged in 1-2 days). No red flags.
...
All 8 agents complete. Full report at `marketing-audit-report.md`.
